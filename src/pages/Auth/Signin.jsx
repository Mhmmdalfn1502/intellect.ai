      ...
      <div class="absolute z-0 blur-xl bottom-10 right-20 size-36 rounded-full bg-radial from-purple-500/40 from-40% to-fuchsia-700/10"></div>
        <div className="flex flex-col">
          <span className="text-[16px] font-semibold text-[#4A3AFF]">
            Hello, <span className="text-[#3D3155]">Welcome Back!</span>
          </span>
          <span className="text-[46px] font-bold text-transparent bg-clip-text bg-gradient-to-r from-[#4A3AFF] to-white">Sign In</span>
          <span className="text-[#8B80A3] text-[16px] font-medium">
            Don't have an account yet?<span> </span>
            <a className="text-[#4A3AFF] font-semibold" href="/signup">
              Sign up
            </a>
          </span>
        </div>
