  ...
  return (
    <div className="bg-white w-screen h-full relative min-h-screen">
      ...
      <div className="relative flex flex-col px-4 lg:px-28 gap-4 z-10">
        ...
        {/* CARD CONTENT */}
        <div className={`ref-scroll overflow-y-scroll grid grid-flow-row h-screen ${isOpen ? "absolute grid-cols-1 lg:grid-cols-4 top-54 right-6 lg:right-32" : "items-center grid-cols-2 lg:grid-cols-5"} gap-4 mb-10 transition-all duration-300`}>
          {courses.map((course) => (
            <a href="" className="flex flex-col hover:border-2 hover:border-[#4A3AFF] justify-between gap-4 bg-white/80 p-4 rounded-4xl w-[180px] lg:w-[210px] h-[310px] lg:h-[330px] backdrop-blur-md drop-shadow-2xl shadow-[#4A3AFF]">
              <div className="flex flex-col gap-2">
